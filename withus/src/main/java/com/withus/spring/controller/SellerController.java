...
public class SellerController {
	...
	public String InquiryList(Principal principal, Model model, String email) {
	...
	public String viewProject(Model model, int prnum) {
	...
	public String write_projectOk(@Valid ProjectFundingDTO dto, @RequestParam("filename") MultipartFile file,
			BindingResult result, Model model) {
		try {
			System.out.println("서버경로" + servletContext.getRealPath(""));// 서버경로 servletContext.getContextPath
			file.transferTo(new File(System.getProperty("user.dir") + "\\src\\main\\resources\\static\\images/"
