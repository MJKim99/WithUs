...
<header>
	...
	<form name="frm" action="updateOkProject" method="post"
		...
		<p class="font-black py-4">시작일 <br> <input type="date" id="start" name="startDate" value="${list[0].startDate }" min="${start }"  class="form-input w-11/12 xl:w-1/5 h-10 "><br>
	...
	<button class="float-left  flex flex-wrap justify-center content-center   bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50   text-white  w-1/12 h-10"  onclick="location.href='/myProject'">목록보기</button>
	</div>
<script>
function chkSubmit() {
